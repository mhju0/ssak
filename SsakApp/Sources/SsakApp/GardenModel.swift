...
public final class GardenModel: ObservableObject {
    ...
    /// untouched (still a seed, empty shelf) — the picker exists only on the start screen,
    /// and this guard keeps a replayed guide from ever eating a real plant. Stage-based,
