...
- **No sound, no haptics** ([ADR-0001](../../adr/0001-no-sound-no-haptics.md)). Levers only: layout, color, type, motion, glass. Portrait-only, iPhone-only, offline, no dependencies. — verbatim (spec §0).
